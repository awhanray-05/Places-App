...
// The navigateAction is built—the call to startCarApp in its OnClickListener
// is the key to interacting with other apps on Android Auto and Android Automotive OS.
